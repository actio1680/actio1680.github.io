...
Los Códigos Santa-Cruz tienen como base el Código Boliviano, si bien hay una revisión en la cantidad de artículos, mantiene la estructura de un Título Preliminar y tres libros, como *Code* frencés[^3]. Por ser de igual contenido ambos Códigos, solo se reproduce un índice. 
